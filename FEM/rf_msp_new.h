...
namespace SolidProp
{
   ...
   class CSolidProperties
   {
	...
	double biot_const;
	int time_biot_curve;					//12.2014 WX
	...
	double Strain_coupling;               //WX HM coupling factor for strain 10.2014
	...
	int COMP_Dependent_E_nv_mode;//WX:01.2014
	double COMP_Dependent_E_nv_value[9];//WX:01.2014
	...
	double E_Function(int dim, double* tmp_stress,double* tmp_stress_0, int ngp);//WX:06.2012
	// 2. Plasticity
         // 2.1 Drucker-Prager
	...
	void AddStrain_by_Deg(const ElementValue_DM* ele_val,
	                        double* stress_n,
	                        double* dstrain,
	                        double temperature = 30);//WX;05.2014
	void CorrectStrain_by_Deg(const ElementValue_DM* ele_val, double* dstress,
                            double* tmp_dstrain, double temperature);//WX: 05.2014
	// Plasticity
	// 1. Drucker-Prager
	double Al;
	double Xi;
